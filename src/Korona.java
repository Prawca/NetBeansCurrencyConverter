...
class Korona {
    double kasa, kurs;
   void przeliczNaKorony() throws IOException{
        try{
            
        Connection connect = Jsoup.connect("https://internetowykantor.pl/kurs-korony-czeskiej/");
...
JOptionPane.showMessageDialog (null,"Kurs korony wynosi " + kurs, "Stawka kursu", JOptionPane.INFORMATION_MESSAGE);
...
wynik /= 100;                   
JOptionPane.showMessageDialog (null,"To jest " + wynik + " koron", "Wynik", JOptionPane.INFORMATION_MESSAGE);
String komunikat1 = "Po przewalutowaniu, bedziesz miał: " + wynik + " koron";
String komunikat2 ="Masz: " + kasa + " złotych \nStawka kursu wynosi: " + kurs +
        "\nPo przewalutowaniu, bedziesz miał: " + wynik + " koron";
System.out.println(komunikat1);
        ...
        if (odp == JOptionPane.YES_OPTION)
        {
            ...
            if (file.showSaveDialog(null) == JFileChooser.APPROVE_OPTION)
            {
                ...
                {
                    Logger.getLogger(Korona.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
...
JOptionPane.showMessageDialog (null,"Kurs korony wynosi: " + kurs, "Stawka kursu", JOptionPane.INFORMATION_MESSAGE);
kasa = Double.parseDouble(JOptionPane.showInputDialog (null,"Podaj ile masz koron:", "Wprowadź dane", JOptionPane.QUESTION_MESSAGE));
if (kasa != 0){
double wynik=kasa*kurs;
wynik *= 100;                 //Można też zaokrąglić tak: String swynik = String.format("%.2f", wynik);
wynik = Math.round(wynik);   //Ale wynik będzie wtedy ze znakiem "," a nie z "."
...
String komunikat2 ="Masz: " + kasa + " koron \nStawka kursu wynosi: " + kurs +
