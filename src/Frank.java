...
class Frank {
    double kasa, kurs;
   void przeliczNaFranki() throws IOException{
        try{
            
        Connection connect = Jsoup.connect("https://internetowykantor.pl/kurs-franka/");
...
JOptionPane.showMessageDialog (null,"Kurs franka wynosi: " + kurs, "Stawka kursu", JOptionPane.INFORMATION_MESSAGE);
...
wynik /= 100;                   
JOptionPane.showMessageDialog (null,"To jest: " + wynik + " franków", "Wynik", JOptionPane.INFORMATION_MESSAGE);
String komunikat1 = "Po przewalutowaniu, bedziesz miał: " + wynik + " franków";
String komunikat2 ="Masz: " + kasa + " złotych \nStawka kursu wynosi: " + kurs +
        "\nPo przewalutowaniu, bedziesz miał: " + wynik + " franków";
...
JOptionPane.showMessageDialog (null,"Kurs franka wynosi " + kurs, "Stawka kursu", JOptionPane.INFORMATION_MESSAGE);
kasa = Double.parseDouble(JOptionPane.showInputDialog (null,"Podaj ile masz franków:", "Wprowadź dane", JOptionPane.QUESTION_MESSAGE));
if (kasa != 0){
double wynik=kasa*kurs;
wynik *= 100;                 //Można też zaokrąglić tak: String swynik = String.format("%.2f", wynik);
wynik = Math.round(wynik);   //Ale wynik będzie wtedy ze znakiem "," a nie z "."
...
String komunikat2 ="Masz: " + kasa + " franków \nStawka kursu wynosi: " + kurs +
