...
class Euro {
    double kasa, kurs;
   void przeliczNaEuro() throws IOException{
        try{
            
        Connection connect = Jsoup.connect("https://internetowykantor.pl/kurs-euro/");
...
JOptionPane.showMessageDialog (null,"Kurs euro wynosi: " + kurs, "Stawka kursu", JOptionPane.INFORMATION_MESSAGE);
...
wynik /= 100;                   
JOptionPane.showMessageDialog (null,"To jest: " + wynik + " euro", "Wynik", JOptionPane.INFORMATION_MESSAGE);
String komunikat1 = "Po przewalutowaniu, bedziesz miał: " + wynik + " euro";
String komunikat2 ="Masz: " + kasa + " złotych \nStawka kursu wynosi: " + kurs +
        "\nPo przewalutowaniu, bedziesz miał: " + wynik + " euro";
System.out.println(komunikat1);
        ...
        if (odp == JOptionPane.YES_OPTION)
        {
            ...
            if (file.showSaveDialog(null) == JFileChooser.APPROVE_OPTION)
            {
                ...
                {
                    Logger.getLogger(Euro.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
...
JOptionPane.showMessageDialog (null,"Kurs euro wynosi " + kurs, "Stawka kursu", JOptionPane.INFORMATION_MESSAGE);
kasa = Double.parseDouble(JOptionPane.showInputDialog (null,"Podaj ile masz euro:", "Wprowadź dane", JOptionPane.QUESTION_MESSAGE));
if (kasa != 0){
double wynik=kasa*kurs;
wynik *= 100;                 //Można też zaokrąglić tak: String swynik = String.format("%.2f", wynik);
wynik = Math.round(wynik);   //Ale wynik będzie wtedy ze znakiem "," a nie z "."
...
String komunikat2 ="Masz: " + kasa + " euro \nStawka kursu wynosi: " + kurs +
